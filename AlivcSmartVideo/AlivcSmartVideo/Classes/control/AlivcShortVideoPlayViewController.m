...
- (void)initCollectionView {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:CELLID bundle:bundle] forCellWithReuseIdentifier:CELLID];
...
- (void)initMaskViews {
    ...
    if (!self.shouldplaySelfVideo) {
        ...
        [liveButton setImage:[AlivcImage imageInSmartVideoNamed:@"alivc_icon_play_liveOnline"] forState:UIControlStateNormal];
...
- (void)loadNewVideo {
    ...
    if( self.shouldplaySelfVideo) {
        ...
        NSLog(@"self.defaultVideoList.=%@",self.defaultVideoList);
