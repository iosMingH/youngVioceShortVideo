...
//    }
//    
    if ([NSStringFromClass([self.vc class]) isEqualToString:@"MHShortVideoLivePlayViewController"]) {
           playViewH = ScreenHeight;
       }
...
- (UIView *)playImageView{
    if (!_playImageView) {
        ...
        UIImageView *imageView = [[UIImageView alloc]initWithImage:[AlivcImage imageInSmartVideoNamed:@"temp_play"]];
