//
//  MHShortVideoPersonalViewController.m
//  App
//
//  Created by Pro on 2020/3/27.
...
@interface MHShortVideoPersonalViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate,UIAlertViewDelegate,AlivcShortVideoElasticViewDelegate,AlivcQuHeaderReusableViewDelegate>
...
@implementation MHShortVideoPersonalViewController
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        //headerView
        NSString *path = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"AlivcSmartVideo.bundle"];
        NSBundle *bundle = [NSBundle bundleWithPath:path];
        [_collectionView registerNib:[UINib nibWithNibName:@"AlivcQuHeaderReusableView" bundle:bundle] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:kHeaderIndetifier];
        //下拉刷新
