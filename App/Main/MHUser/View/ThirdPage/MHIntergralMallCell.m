...
-(void)initControl{
           // 情景二：采用网络图片实现
               NSArray *imagesURLStrings = @[
                                      ...
                                      @"https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1262655631,4054846463&fm=26&gp=0.jpg",
...
//            containerView.backgroundColor = [UIColor yellowColor];
    ...
    //        // 网络加载 --- 创建带标题的图片轮播器
            SDCycleScrollView *cycleScrollView2 = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 10, w, AUTO(160)) delegate:self placeholderImage:[UIImage imageNamed:@"placeholder"]];
