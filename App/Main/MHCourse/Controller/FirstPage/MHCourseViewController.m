...
@interface MHCourseViewController ()
<
UITableViewDelegate,
...
@implementation MHCourseViewController
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    MHCourseSortView *headView1 = [tableView dequeueReusableHeaderFooterViewWithIdentifier:headId];
...
- (void)setupModelOfHeadView:(MHCourseSortView *)headView section:(NSInteger)section{
