    ...
    switch (sender.view.tag) {
        case kFavoriteViewLikeBeforeTag: {
            [self startLikeAnim:YES];
             [[NSNotificationCenter defaultCenter]postNotificationName:@"notification_addLikeVideo" object:nil];
            break;
        }
        case kFavoriteViewLikeAfterTag: {
            [self startLikeAnim:NO];
             [[NSNotificationCenter defaultCenter]postNotificationName:@"notification_cancelLikeVideo" object:nil];
            break;
        }
    }
}
