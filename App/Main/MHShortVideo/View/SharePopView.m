...
- (instancetype)init {
    ...
    if (self) {
        ...
        _container = [[UIView alloc] initWithFrame:CGRectMake(0, DEVICEHEIGH, DEVICEWIDTH, 280 + SafeBottom)];
        ...
        _cancel = [[UIButton alloc] initWithFrame:CGRectMake(0, 230, ScreenWidth, 50 + SafeBottom)];
        [_cancel setTitleEdgeInsets:UIEdgeInsetsMake(-SafeBottom, 0, 0, 0)];
