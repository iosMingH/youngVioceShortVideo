...
#import "MHPublishQuViewControl.h"
...
@interface MHPublishQuViewControl ()<UITextFieldDelegate>
...
@implementation MHPublishQuViewControl
...
- (UIButton *)backButton {
    if (!_backButton) {
        ...
        [_backButton setImage:[AlivcImage imageInSmartVideoNamed:@"avcBackIcon"]
