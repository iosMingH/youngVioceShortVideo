...
@interface MHSVideoApi : NSObject
/**
 获取图片上传的凭证
...
//大叶网 -----============
+ (void)dayeGetImageUploadAuthWithToken:(NSString *_Nullable)tokenString
...
+ (void)dayeGetVideoUploadAuthWithWithToken:(NSString *_Nullable)tokenString
