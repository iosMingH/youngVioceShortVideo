...
@class MHShortVideoPublishManager;
...
@protocol MHShortVideoPublishManagerDelegate <NSObject>
...
@interface MHShortVideoPublishManager : NSObject
/**
 单例 - 主要为了使用方便和模块间的低耦合
...
/**
 本次合成与上传发生事情的回调代理
 */
@property (nonatomic, weak) id<MHShortVideoPublishManagerDelegate> managerDelegate;
