...
#define kCellID @"cell"
@interface MHPageContentView()<UICollectionViewDataSource,UICollectionViewDelegate>
{
...
@implementation MHPageContentView
...
- (instancetype)initWithFrame:(CGRect)frame childVcs:(NSMutableArray *)childVcs parentViewController:(UIViewController *)parentViewController index:(NSInteger)index
{
    ...
    //设置默认是第几页开始  ------- MH
     [self.collectionView setContentOffset:CGPointMake(DEVICEWIDTH*index, 0)];
