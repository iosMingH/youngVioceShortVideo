...
+ (NSString *)AESEncrypt:(NSString *)encryptContent key:(NSString *)key
{
    ...
    NSData* data = [encryptContent dataUsingEncoding:NSUTF8StringEncoding];
...
+ (NSString *)AESDecrypt:(NSString *)encryptContent key:(NSString *)key
{
    ...
    NSData *data = [[NSData alloc] initWithBase64EncodedString:encryptContent options:NSDataBase64DecodingIgnoreUnknownCharacters];//base64解码
