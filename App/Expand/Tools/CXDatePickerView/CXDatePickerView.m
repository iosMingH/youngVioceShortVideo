...
- (void)setupUI {
    self.frame = CGRectMake(0, 0, kScreenWidth1, kScreenHeight1);
...
- (void)show {
    ...
    [UIView animateWithDuration:self.showAnimationTime animations:^{
        ...
        self.buttomView.frame = CGRectMake(0, kScreenHeight1 - buttomViewHeight, kScreenWidth1, buttomViewHeight);
...
- (void)dismiss {
    [UIView animateWithDuration:self.showAnimationTime animations:^{
        CGFloat buttomViewHeight = self.pickerViewHeight + self.topViewHeight;
        self.buttomView.frame = CGRectMake(0, kScreenHeight1, kScreenWidth1, buttomViewHeight);
