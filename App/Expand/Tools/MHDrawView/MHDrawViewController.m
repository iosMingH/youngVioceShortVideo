...
@interface MHDrawViewController ()<UIGestureRecognizerDelegate>
...
/**
 菜单的显示区域占屏幕宽度的百分比
 */
static const CGFloat MenuWidthScale = 0.7f;
/**
 遮罩层最高透明度
 */
...
@implementation MHDrawViewController
{
