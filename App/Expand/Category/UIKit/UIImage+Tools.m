...
- (NSString *) imageToBase64
{
    ...
    NSString *encodedStr = [data base64EncodedStringWithOptions:
                            NSDataBase64Encoding64CharacterLineLength];
    
//    NSLog(@"encodedImageStr==%@",encodedImageStr);
    return [NSString stringWithFormat:@"base64,%@", encodedStr];
}
...
+ (UIImage *) base64ToImage: (NSString *) imgSrc
{
    ...
    NSData *decodedImageData = [[NSData alloc]
                                ...
                                initWithBase64EncodedString:imgSrc options:NSDataBase64DecodingIgnoreUnknownCharacters];
...
{
    return [[UIImage imageNamed:name] resizableImageWithCapInsets:UIEdgeInsetsZero resizingMode:UIImageResizingModeStretch];
}
