...
+ (BOOL)sendImageData:(NSData *)imageData
    ...
    WXMediaMessage* ms = [[WXMediaMessage alloc]init];
    ms.title = messageExt;
//    ms.thumbData = thumbImage;
    ms.mediaObject = ext;
    SendMessageToWXReq* req = [[SendMessageToWXReq alloc]init];
    req.bText = NO;
    req.message = ms;
...
+ (BOOL)sendLinkURL:(NSString *)urlString
    ...
    WXMediaMessage* mse = [[WXMediaMessage alloc]init];
    mse.thumbData = UIImagePNGRepresentation(thumbImage);
     SendMessageToWXReq* req = [[SendMessageToWXReq alloc]init];
    req.message = mse;
    req.bText = NO;
    req.scene = scene;
...
+(void)jumpPayBizpay:(PaysignModel*)model
{
