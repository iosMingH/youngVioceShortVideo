...
{
    NSString *string = [NSString stringWithFormat:@"%ld-%02ld-%02ld",[self getYear],[self getMonth],[self getDay]];
    return string;
}
...
{
    NSString *string = [NSString stringWithFormat:@"%ld-%02ld",[self getYear],[self getMonth]];
    return string;
}
