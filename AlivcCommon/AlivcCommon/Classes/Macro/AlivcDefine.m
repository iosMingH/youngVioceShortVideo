...
NSString * const AlivcEditPlayerPasterFontName = @"AlivcEditPlayerPasterFontName";

NSString * const kAlivcQuUrlString =  @"https://alivc-demo.aliyuncs.com";



//NSString * const kAlivcQuUrlString =  @"http://47.100.18.52:8081";

NSString * const AlivcVideoPlayUrlString  = @"https://vod.cn-shanghai.aliyuncs.com/?";
//NSString * const kAlivcQuUrlString = @"http://47.102.219.109:8080/swagger-ui.html#/demo-controller";


//大叶网 ---------------
//NSString * const kAlivcDayeUrlString =  @"http://192.168.2.118:8080";
//

NSString * const kAlivcDayeUrlString =  @"http://192.168.9.144:8088/video";
